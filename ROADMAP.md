...
[CQ-205 / GitHub #14](https://github.com/manmohanml1/consensus/issues/14), [CQ-202 / GitHub #11](https://github.com/manmohanml1/consensus/issues/11), and [CQ-203 / GitHub #12](https://github.com/manmohanml1/consensus/issues/12) completed the protocol, portable persistence, and anonymous capability foundations. CQ-204 / GitHub #13 and CQ-210 / GitHub #19 are grouped in one dependency-compatible delivery unit for transactional commands and privacy-minimized projections; each retains separate acceptance evidence and issue closure. Tiny or tightly coupled backlog items should share a PR when that produces one coherent review and recovery boundary. [CQ-201 / GitHub #10](https://github.com/manmohanml1/consensus/issues/10) recovery/teardown evidence and the first shared Neon migration remain separate owner gates.
