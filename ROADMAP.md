...
[CQ-205 / GitHub #14](https://github.com/manmohanml1/consensus/issues/14) completed the provider-neutral room protocol contracts in PR #111. [CQ-202 / GitHub #11](https://github.com/manmohanml1/consensus/issues/11) completed the portable schema, ordered migration runner, privilege boundary, and disposable PostgreSQL tests in PR #132. [CQ-203 / GitHub #12](https://github.com/manmohanml1/consensus/issues/12) is now implementing anonymous capability issuance, hashing, scope, expiry, rotation primitives, and safe cookie delivery. [CQ-201 / GitHub #10](https://github.com/manmohanml1/consensus/issues/10) recovery/teardown evidence and the first shared Neon migration remain separate owner gates.
