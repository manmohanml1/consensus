...
[CQ-205 / GitHub #14](https://github.com/manmohanml1/consensus/issues/14) completed the provider-neutral room protocol contracts in PR #111. [CQ-201 / GitHub #10](https://github.com/manmohanml1/consensus/issues/10) provisioned and verified the owner-approved Free Neon resource for Development and Preview; recovery/teardown evidence remains open. The owner started [CQ-202 / GitHub #11](https://github.com/manmohanml1/consensus/issues/11), which now defines the portable schema, ordered migration runner, privilege boundary, and disposable PostgreSQL tests. Applying the first migration to Neon remains a separate owner gate.
