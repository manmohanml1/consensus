...
| ------- | ------------------------------------------------------------------------------------------ | ------- |
| 0.1.0   | Repository contracts, decision-engine foundation, and accessible single-device slice       | Active  |
| 0.2.0   | Host-created food decision with manual/curated candidates and no account requirement       | Planned |
